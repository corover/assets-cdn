var CoRoverWidget = (function (exports) {
  'use strict';
  ...
  var log = function () {
    ...
    if (config.debug) {
      (_a = window.console).log.apply(
        _a,
        __spreadArray(
          ['%cwidget-script%c', 'color: blue', 'color: initial'],
          args,
        ),
      );
    }
  ...
  var updateWidgetStyle = function (isOpened, options) {
    if (smallScreen) {
      if (isOpened) {
        ...
        document.body.style.cssText +=
          'overflow: hidden; height: 100%; width: 100%; position: fixed; top: ' +
          scrollPosition +
          'px;';
      } else {
    ...
    if (isOpened) {
       ...
       */
      iframe.style.width = smallScreen
        ? '100%'
        : WIDGET_MARGIN + WIDGET_OPEN_WIDTH + WIDGET_MARGIN + 'px';
      ...
      iframe.style.width = (
        options === null || options === void 0 ? void 0 : options.triggerMessage
      )
        ? WIDGET_MARGIN + WIDGET_MINIMIZED_WIDTH + WIDGET_MARGIN + 'px'
        : '60px';
      iframe.style.height =
        WIDGET_MARGIN + WIDGET_MINIMIZED_HEIGHT + WIDGET_MARGIN + 'px';
    }
  };
  var createWidget = function (url, options) {
    ...
    iframe.setAttribute(
      'style',
      'border: none; display: block; position: fixed; top: auto; bottom:12px; visibility: visible; max-width: 100vw; transition: all 0.3s ease-in-out, width 0ms; background: none transparent; opacity: 1; pointer-events: auto; touch-action: auto;',
    );
    iframe.style.width = (
      options === null || options === void 0 ? void 0 : options.triggerMessage
    )
    ...
    if (
      ((_a = config === null || config === void 0 ? void 0 : config.options) ===
        null || _a === void 0
        ? void 0
        : _a.widgetPosition) === 'RIGHT'
    ) {
      iframe.style.left = 'auto';
    ...
    window.addEventListener(
      ...
      function (msg) {
        if (
          ...
          msg.data.src === 'gb.whatsapp.widget'
        ) {
          if (
            api[msg.data.fn] !== undefined &&
            typeof api[msg.data.fn] === 'function'
          ) {
            var args = [].concat(msg.data.args || []);
            log.apply(
              void 0,
              __spreadArray(['receivedMessage.' + msg.data.fn], args),
            );
  ...
  init(window.CoRoverWidget);
  /* if (typeof window.CORwc.url !== "undefined") {
        CORWidget.init(window.CORwc);
    } */
